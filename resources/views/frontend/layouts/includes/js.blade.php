...
<script src="{{ asset('frontend/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.5') }}"></script>
<script src="{{ asset('frontend/assets/js/scripts.bundle.js?v=7.0.5') }}"></script>
<!--end::Global Theme Bundle-->
<!--begin::Page Vendors(used by this page)-->
<script src="{{ asset('frontend/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.5') }}"></script>
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="{{ asset('frontend/assets/js/pages/widgets.js?v=7.0.5') }}"></script>

<!--begin::Page Scripts(used by this page)-->
<!-- <script src="{{ asset('frontend/assets/js/pages/crud/file-upload/dropzonejs.js') }}"></script> -->
<!--begin::Page Scripts(used by this page)-->
<script src="{{ asset('frontend/assets/js/pages/crud/forms/validation/form-widgets.js?v=7.0.5') }}"></script>
<!--end::Page Scripts-->
<!--end::Page Scripts-->
<!--end::Page Scripts-->
<script src="{{ asset('frontend/assets/js/pages/custom/profile/profile.js?v=7.0.5') }}"></script>
