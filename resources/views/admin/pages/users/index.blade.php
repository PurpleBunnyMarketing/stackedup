    ...
    $(document).ready(function () {
        ...
        oTable = $('#users_table').DataTable({
            ...
            ajax: {
                ...
                data: {
                    columnsDef: ['checkbox','full_name','company_name', 'email', 'mobile_no', 'active', 'action'],
                },
            },
            columns: [
                { data: 'checkbox' },
            ...
            columnDefs: [
                ...
                { targets: 1, title: 'Full Name', orderable: true },
                { targets: 2, title: 'Company Name', orderable: false },
                { targets: 3, title: 'Email', orderable: true },
                { targets: 4, title: 'Mobile Number', orderable: true },
