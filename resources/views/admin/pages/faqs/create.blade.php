...
<div class="container">
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form id="frmAddFaqs" method="POST" action="{{ route('admin.faqs.store') }}">
            @csrf
            <div class="card-body">
                {{-- Question --}}
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('answer') is-invalid @enderror" rows="10" id="answer" name="answer" placeholder="Enter Answer" autocomplete="answer" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />{{ old('answer') }}</textarea>
