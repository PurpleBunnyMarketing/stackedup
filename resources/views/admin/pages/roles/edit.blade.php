                ...
                <div class="table-responsive form-group{{ $errors->has('roles') ? ' has-error' : '' }}">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            // $index = $key+1;
                            // dd($user_permission);
                            $permissions = !empty($user_permission[$user_role->id]) ? explode(',',
                            $user_permission[$user_role->id]['permissions']) : [];
                            @endphp
                            @if ($user_role->id != 1)
                            <tr class="role_row_{{ $roleId }}">
                                ...
                                <td>
                                    ...
                                    <input class="premision_check role_{{ $roleId }}" data-id="{{ $roleId }}"
                                        data-error-container='#permission_error'
                                        name="roles[{{ strtolower($user_role->id) }}][permissions][]" type="checkbox"
                                        value="access" {{ in_array('access', $permissions) ? 'checked' : '' }} {{
                                        $roleId==1 ? 'checked disabled' : '' }}>
                                    @if ($user_role->id == 1)
                                    <input type="hidden" name="roles[{{ strtolower($user_role->id) }}][permissions][]"
                                        value="access">
                                    @endif
                                ...
                                <td>
                                    ...
                                    <input class="premision_check role_{{ $roleId }}" data-id="{{ $roleId }}"
                                        data-error-container='#permission_error'
                                        name="roles[{{ strtolower($user_role->id) }}][permissions][]" type="checkbox"
                                        value="add" {{ in_array('add', $permissions) ? 'checked' : '' }}>
                                    @php $total_count++ @endphp
                                    @else
                                    N / A
                                    @endif
                                ...
                                <td>
                                    ...
                                    <input class="premision_check role_{{ $roleId }}" data-id="{{ $roleId }}"
                                        data-error-container='#permission_error'
                                        name="roles[{{ strtolower($user_role->id) }}][permissions][]" type="checkbox"
                                        value="edit" {{ in_array('edit', $permissions) ? 'checked' : '' }}>
                                    @php $total_count++ @endphp
                                    @else
                                    N / A
                                    @endif
                                ...
                                <td>
                                    ...
                                    <input class="premision_check role_{{ $roleId }}" data-id="{{ $roleId }}"
                                        data-error-container='#permission_error'
                                        name="roles[{{ strtolower($user_role->id) }}][permissions][]" type="checkbox"
                                        value="delete" {{ in_array('delete', $permissions) ? 'checked' : '' }}>
                                    @php $total_count++ @endphp
                                    @else
                                    N / A
                                    @endif
                                ...
                                <td>
                                    ...
                                    <input class="premision_check role_{{ $roleId }}" data-id="{{ $roleId }}"
                                        data-error-container='#permission_error'
                                        name="roles[{{ strtolower($user_role->id) }}][permissions][]" type="checkbox"
                                        value="view" {{ in_array('view', $permissions) ? 'checked' : '' }}>
                                    @php $total_count++ @endphp
                                    @else
                                    N / A
                                    @endif
                                </td>
                                <td><input type="checkbox" class="checkrow all_rolechecked_{{ $roleId }}"
