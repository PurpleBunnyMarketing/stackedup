    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        <form id="frmAddRoles" class="form-horizontal" role="form" method="POST"
                        ...
                        <tbody>
                            ...
                            <tr class="role_row_{{ $role->id }}">
                                ...
                                <td>
                                    ...
                                    <input class="premision_check role_{{ $role->id }}" data-id="{{ $role->id }}"
                                        data-error-container='#permission_error'
                                        name="roles[{{ strtolower($role->id) }}][permissions][]" type="checkbox"
                                        value="access" {{ $role->id == 1 ? 'checked disabled' : '' }}>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary mr-2 text-uppercase">Submit</button>
