                ...
                <div class="tab-content">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <div class="image-input image-input-outline" id="kt_profile_avatar"
                                                ...
                                                <div class="image-input-wrapper"
                                                    style="background-image:url({{ $user->asset_profile}})"></div>
                                                <label
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <input class="form-control form-control-lg" name="full_name" id="full_name"
                                                type="text" value="{{ $user->full_name }}" placeholder="Enter name" />
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label text-lg-right">Contact
                                            Number</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input type="text" class="form-control form-control-lg" name="contact_no"
                                                id="contact_no" value="{{ $user->contact_no}}"
                    ...
                    <div class="tab-pane" id="change_password">
                        <div class="card card-custom">
                            ...
                            <!--begin::Form-->
                            <form class="form" id="change_password_form" action="{{ route('admin.update-password')}}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <div class="input-group">
                                                <input type="password"
                                                    class="form-control h-auto py-4 px-8 @error('current_password') is-invalid @enderror"
                                                    id="current_password" name="current_password"
                                                    placeholder="Current password"
                                                    data-error-container="#old-password-error" />
                                                <div class="input-group-append"><span class="input-group-text"><i
                                                            class="far fa-eye" id="toggleOldPassword"></i></span></div>
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <div class="input-group">
                                                <input type="password"
                                                    ...
                                                    data-error-container="#password-error" />
                                                <div class="input-group-append"><span class="input-group-text"><i
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <div class="input-group">
                                                <input type="password"
                                                    class="form-control h-auto py-4 px-8 @error('confirm_password') is-invalid @enderror"
                                                    id="confirm_password" name="confirm_password"
                                                    placeholder="Verify password"
                                                    data-error-container="#confirm-password-error" />
                                                <div class="input-group-append"><span class="input-group-text"><i
                                                            class="far fa-eye"
                                                            id="togglePasswordConfirmation"></i></span></div>
...
<script type="text/javascript">
        ...
        $('#profile_update_form').validate({
            ...
            messages: {
                ...
                contact_no:{
                    ...
                    maxlength:"@lang('validation.max.numeric',['attribute'=>'contact number','max'=>10])"
                },
                profile_avatar:{
    ...
    const toggleOldPassword = document.querySelector('#toggleOldPassword');
            const oldPassword = document.querySelector('#current_password');
