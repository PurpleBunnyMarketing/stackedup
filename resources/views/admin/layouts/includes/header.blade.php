				...
				<ul class="menu-nav">
					...
					<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here "
						...
						<div class="menu-submenu menu-submenu-classic menu-submenu-left">
							<ul class="menu-subnav" data-wheel-propagation="true" data-scroll="true"
						...
						<div class="btn btn-icon btn-clean btn-dropdown w-auto align-items-center btn-lg mr-1 px-2">
							...
							<span class="symbol symbol-35 symbol-light-success">
								<span class="symbol-label font-size-h5 font-weight-bold">
									...
									<img src={{generateURL(auth()->user()->profile)}} height="35" width="35"
									class="rounded" alt="profile image"
									/>
									@else
									<img src="{{ asset('assets/media/users/blank.png')}}" height="35" width="35" class="rounded" alt="profile image">
									@endif
								</span>
							</span>
						</div>
