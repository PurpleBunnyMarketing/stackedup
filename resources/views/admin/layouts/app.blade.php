...
<head>
    ...
    <title>{{ !empty($custom_title) ? $custom_title : 'Admin Panel' }} | {{ config('app.name', 'Backend') }} </title>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	{{--Page Loader --}}
	<div class="page-loader page-loader-base" id="overlayDocument"><div class="page-loader page-loader-non-block" ><div class="blockui" style="box-shadow:unset;"><div class="custom-loader"></div></div></div></div>
